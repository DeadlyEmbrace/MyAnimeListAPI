    ...
    public static class Manga
    {
        ...
        public static async Task<string> GetMangaDetailAsync(int mangaId)
        {
            ...
            try
            {
                ...
                result = await WebRequest.Create(string.Format(MangaUrl + "{0}{1}{2}", "manga/", mangaId, queryParameter), "GET");
        ...
        public static async Task<string> GetMangaDetailAsync(int mangaId, string login, string password)
        {
            ...
            try
            {
                ...
                result = await WebRequest.Create(string.Format(MangaUrl + "{0}{1}{2}{3}", "manga/", mangaId, "?mine=1", queryParameter), login, password, "GET");
